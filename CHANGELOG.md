...
## 2.0.0
- Current consolidated version of HumanEdit.
- Russian-first rewrite system with soft and hard modes.
- Added anti-slop rules for rhythm, symmetry, passive voice, vague abstractions, and structural inflation.
...
## 1.0.0
- Initial release of HumanEdit.
- Core anti-slop rewrite rules based on talk-normal v0.6.2 by hexiecs.
- Russian-first focus with English as a secondary layer.
- Added soft and hard editing modes.
